...
export const HERO_SLIDES = [
  ...
  {
    gambar: '/images/hero/hero-4.jpg',
    alt: 'Suasana kota Singaraja dengan aktivitas pelayanan publik digital',
    judul: 'Menuju',
    sorot: 'Smart Island Buleleng',
    ekor: '2029',
    teks: 'Satu Data Buleleng, sistem peringatan dini bencana, dan layanan desa terpadu — inovasi digital yang lahir dari kolaborasi riset lintas kampus dan perangkat daerah.'
  }
];
